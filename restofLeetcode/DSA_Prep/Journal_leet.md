...
Did inverse linked list twice, then attempted linked list 2. Also did pally-linked list. Did remove_nodes_from_linked_list on first go using a monotomic stack and linked list combo; feel pretty good about that. Did delete_node_in_linked_list with help. Also did remove linked list elements. Also did remove center of linked list. Also did middle of linked list
