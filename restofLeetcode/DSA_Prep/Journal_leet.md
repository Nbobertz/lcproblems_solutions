...
Did 3sum today.Also did simplify path
...
Today I am doing convergence (3sum) again. Just got to keep grinding. I found it hard to conceptually solve the problem but I am getting there. Did a normal problem and as usual overcomplicated it. Two-sum input array is sorted can be solved with two pointer.

Today I did 2 problem